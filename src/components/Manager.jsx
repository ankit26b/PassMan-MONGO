  ...
  return (
    <>
      ...
      <div className="p-2 md:mycontainer mx-auto min-h-[83.2vh]">
        ...
        <p className="text-green-900 text-lg text-center py-2 w-32">
        ...
        <div className="text-black flex flex-col p-4 gap-8 items-center">
          <input
            ...
            className="rounded-full border border-emerald-500 w-full p-4 py-1"
            type="text"
            name="site"
            id="site"
          />
          ...
          <div className="flex flex-col md:flex-row w-full justify-between gap-8">
            ...
            <div className="relative">
              ...
              />
              <span
                className="absolute right-2 py-1 invert cursor-pointer"
          ...
          <button
            ...
            className="flex text-emerald-500 justify-center items-center gap-2 bg-slate-600 hover:bg-green-200 rounded-full px-4 py-2 w-fit border border-slate-900"
          >
            <lord-icon
